...
import { Pair, Bundle, Token, SimplifiedFactory, SimplifiedDayData, PairDayData, TokenDayData } from '../types/schema'
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from './helpers'

export function updateSimplifiedDayData(event: EthereumEvent): SimplifiedDayData {
